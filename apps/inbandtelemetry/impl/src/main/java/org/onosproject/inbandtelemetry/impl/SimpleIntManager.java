...
public class SimpleIntManager implements IntService {
    ...
    public void activate() {
        ...
        /* -------------------------------------------------------------------------------------------------------------------------------------------------
        //                                                                  ypy 20201211 auto add intconfig  
        if (reportConfig == null) {
            IpAddress collectorIp = IpAddress.valueOf("127.0.0.1");
            TpPort collectorPort = TpPort.tpPort(54321);
            
            reportConfig.setCollectorIp(collectorIp);
            reportConfig.setCollectorPort(collectorPort);
            reportConfig.setMinFlowHopLatencyChangeNs(300);
        }
        // -------------------------------------------------------------------------------------------------------------------------------------------------
        */
